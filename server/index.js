...
export default function (cfg, storageProvider) {
  ...
  app.use(routes.dashboardAdmins({
    ...
    scopes: 'read:authentication_methods read:clients delete:clients read:connections read:users update:users delete:users create:users read:logs read:device_credentials update:device_credentials delete:device_credentials delete:guardian_enrollments'
  }));
